...
class Google_Service_YouTubePartner extends Google_Service
{
  ...
  const YOUTUBEPARTNER_CONTENT_OWNER_READONLY = "https://www.googleapis.com/auth/youtubepartner-content-owner-readonly";
...
class Google_Service_YouTubePartner_AssetLabels_Resource extends Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
    * owners.
...
class Google_Service_YouTubePartner_AssetMatchPolicy_Resource extends Google_Service_Resource
{
   ...
   * The assetId parameter specifies the YouTube asset ID of the asset for which you are retrieving
    * the match policy.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
...
class Google_Service_YouTubePartner_AssetRelationships_Resource extends Google_Service_Resource
{
   ...
   * The assetRelationshipId parameter specifies a value that uniquely identifies the relationship
    * you are deleting.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
   ...
   *
   * @param string $assetId
   * The assetId parameter specifies the asset ID of the asset for which you are retrieving
    * relationships.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken
   * The pageToken parameter specifies a token that identifies a particular page of results to
    * return. Set this parameter to the value of the nextPageToken value from the previous API
...
class Google_Service_YouTubePartner_AssetSearch_Resource extends Google_Service_Resource
{
   ...
   * The sort parameter specifies how the search results should be sorted. Note that results are
    * always sorted in descending order.
   * @opt_param string q
   * YouTube searches within the id, type, and customId fields for all assets as well as in numerous
    * other metadata fields – such as actor, album, director, isrc, and tmsId – that vary for
    * different types of assets (movies, music videos, etc.).
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
    * owners.
   * @opt_param string labels
   * The labels parameter specifies the assets with certain asset labels that you want to retrieve.
    * The parameter value is a comma-separated list of asset labels.
   * @opt_param bool includeAnyProvidedlabel
   * If includeAnyProvidedlabel parameter is set to true, will search for assets that contain any of
    * the provided labels; else will search for assets that contain all the provided labels.
   * @opt_param string pageToken
   * The pageToken parameter specifies a token that identifies a particular page of results to
    * return. Set this parameter to the value of the nextPageToken value from the previous API
    * response to retrieve the next page of search results.
   * @opt_param string ownershipRestriction
   * The ownershipRestriction parameter specifies the ownership filtering option for the search. By
    * default the search is performed in the assets owned by currently authenticated user only.
   * @opt_param string metadataSearchFields
   * The metadataSearchField parameter specifies which metadata fields to search by. It is a comma-
    * separated list of metadata field and value pairs connected by colon(:). For example:
    * customId:my_custom_id,artist:Dandexx
   * @opt_param bool hasConflicts
   * The hasConflicts parameter enables you to only retrieve assets that have ownership conflicts.
    * The only valid value is true. Setting the parameter value to false does not affect the results.
   * @opt_param string type
   * The type parameter specifies the types of assets that you want to retrieve. The parameter value
    * is a comma-separated list of asset types.
...
class Google_Service_YouTubePartner_Assets_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string fetchMatchPolicy
   * The fetchMatchPolicy parameter specifies the version of the asset's match policy that should be
    * returned in the API response.
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
    * owners.
   * @opt_param string fetchOwnership
   * The fetchOwnership parameter specifies the version of the asset's ownership data that should be
    * returned in the API response. As with asset metadata, YouTube can receive asset ownership data
    * from multiple sources.
   * @opt_param string fetchMetadata
   * The fetchMetadata parameter specifies the version of the asset's metadata that should be
    * returned in the API response. In some cases, YouTube receives metadata for an asset from
    * multiple sources, such as when different partners own the asset in different territories.
   * @opt_param bool fetchOwnershipConflicts
   * The fetchOwnershipConflicts parameter allows you to retrieve information about ownership
    * conflicts.
   ...
   *
   * @param string $id
   * The id parameter specifies a comma-separated list of YouTube Asset IDs that identify the assets
    * you want to retrieve. As noted in the method description, if you try to retrieve an asset that
    * YouTube identified as a duplicate and merged with another asset, the API response only returns
    * the synthesized asset. In that case, the aliasId property in the asset resource specifies a list
    * of other asset IDs that can be used to identify that asset.
  Also note that the API response
    * does not contain duplicates. As such, if your request identifies three asset IDs, and all of
    * those have been merged into a single asset, then the API response identifies one matching asset.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string fetchMatchPolicy
   * The fetchMatchPolicy parameter specifies the version of the asset's match policy that should be
...
class Google_Service_YouTubePartner_ClaimHistory_Resource extends Google_Service_Resource
{
   ...
   * The claimId parameter specifies the YouTube claim ID of the claim for which you are retrieving
    * the claim history.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
...
class Google_Service_YouTubePartner_ClaimSearch_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string origin
   * The origin parameter specifies the origins you want to find claims for. It is a comma-separated
   ...
   * The createdAfter parameter allows you to restrict the set of returned claims to ones originally
    * created after the specified date.
   * @opt_param string contentType
   * The contentType parameter specifies the content type of claims that you want to retrieve.
   * @opt_param string assetId
   * The assetId parameter specifies the YouTube asset ID of the asset for which you are retrieving
    * claims.
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
   ...
   * The videoId parameter specifies comma-separated list of YouTube video IDs for which you are
    * retrieving claims.
   * @opt_param string q
   * The q parameter specifies the query string to use to filter search results. YouTube searches for
    * the query string in the following claim fields: video_title, video_keywords, user_name, isrc,
    * iswc, grid, custom_id, and in the content owner's email address.
   * @opt_param string pageToken
   * The pageToken parameter specifies a token that identifies a particular page of results to
    * return. For example, set this parameter to the value of the nextPageToken value from the
    * previous API response to retrieve the next page of search results.
   * @opt_param string createdBefore
   * The createdBefore parameter allows you to restrict the set of returned claims to ones originally
    * created before the specified date.
   * @opt_param bool includeThirdPartyClaims
   * Used along with the videoId parameter this parameter determines whether or not to include third
    * party claims in the search results.
...
class Google_Service_YouTubePartner_Claims_Resource extends Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    ...
    * owners.
   * @opt_param string assetId
   * Use the claimSearch.list method's assetId parameter to search for claim snippets by asset ID.
    * You can then retrieve the claim resources for those claims by using this method's id parameter
    * to specify a comma-separated list of claim IDs.
   * @opt_param string videoId
   * Use the claimSearch.list method's videoId parameter to search for claim snippets by video ID.
    * You can then retrieve the claim resources for those claims by using this method's id parameter
    * to specify a comma-separated list of claim IDs.
   * @opt_param string q
   * Use the claimSearch.list method's q parameter to search for claim snippets that match a
    * particular query string. You can then retrieve the claim resources for those claims by using
    * this method's id parameter to specify a comma-separated list of claim IDs.
   * @opt_param string pageToken
   * The pageToken parameter specifies a token that identifies a particular page of results to
    * return. For example, set this parameter to the value of the nextPageToken value from the
    * previous API response to retrieve the next page of search results.
...
class Google_Service_YouTubePartner_ContentOwners_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool fetchMine
   * The fetchMine parameter restricts the result set to content owners associated with the currently
...
class Google_Service_YouTubePartner_LiveCuepoints_Resource extends Google_Service_Resource
{
   ...
   * The channelId parameter identifies the channel that owns the broadcast into which the cuepoint
    * is being inserted.
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
    * owners. You can obtain the content owner ID that will serve as the parameter value by calling
    * the YouTube Content ID API's contentOwners.list method.
...
class Google_Service_YouTubePartner_MetadataHistory_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $assetId
   * The assetId parameter specifies the YouTube asset ID of the asset for which you are retrieving a
    * metadata history.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
...
class Google_Service_YouTubePartner_Orders_Resource extends Google_Service_Resource
{
   ...
   *
   * @opt_param string status
   * Filter results to have this status, available options are STATUS_AVAILED, STATUS_ORDERED,
    * STATUS_RECEIVED, STATUS_READY_FOR_QC, STATUS_MOC_FIX, STATUS_PARTNER_FIX, STATUS_YOUTUBE_FIX,
    * STATUS_QC_APPROVED, STATUS_INACTIVE, STATUS_INGESTION_COMPLETE, STATUS_REORDERED
   * @opt_param string q
   ...
   * The continuation token is an optional value that is only used to page through large result sets.
    * - To retrieve the next page of results for a request, set this parameter to the value of the
    * nextPageToken value from the previous response.
  - To get the previous page of results, set this
    * parameter to the value of the previousPageToken value from the previous response.
   * @opt_param string productionHouse
...
class Google_Service_YouTubePartner_Ownership_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $assetId
   * The assetId parameter specifies the YouTube asset ID for which you are retrieving ownership
    * data.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
...
class Google_Service_YouTubePartner_Policies_Resource extends Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    ...
    * owners.
   * @opt_param string id
   * The id parameter specifies a comma-separated list of saved policy IDs to retrieve. Only policies
    * belonging to the currently authenticated content owner will be available.
...
class Google_Service_YouTubePartner_Publishers_Resource extends Google_Service_Resource
{
   ...
   * The publisherId parameter specifies a publisher ID that uniquely identifies the publisher being
    * retrieved.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
  ...
  /**
   * Creates a publisher. (publishers.insert)
   *
   * @param Google_Publisher $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
   ...
   * @return Google_Service_YouTubePartner_Publisher
   */
  public function insert(Google_Service_YouTubePartner_Publisher $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Google_Service_YouTubePartner_Publisher");
  }
  /**
   ...
   * The pageToken parameter specifies a token that identifies a particular page of results to
    * return. Set this parameter to the value of the nextPageToken value from the previous API
    * response to retrieve the next page of search results.
   * @opt_param string namePrefix
   * The namePrefix parameter indicates that the API should only return publishers whose name starts
    * with this prefix.
   * @opt_param string ipiNumber
...
class Google_Service_YouTubePartner_ReferenceConflicts_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $referenceConflictId
   * The referenceConflictId parameter specifies the YouTube reference conflict ID of the reference
    * conflict being retrieved.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
...
class Google_Service_YouTubePartner_References_Resource extends Google_Service_Resource
{
   ...
   * content. In this flow, you can use either the multipart or resumable upload
   * flows to provide the reference content. - If you want to create a reference
   * using a claimed video as the reference content, use the claimId parameter to
   * identify the claim. (references.insert)
   *
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
    * owners.
   * @opt_param string claimId
   * The claimId parameter specifies the YouTube claim ID of an existing claim from which a reference
    * should be created. (The claimed video is used as the reference content.)
   * @return Google_Service_YouTubePartner_Reference
   */
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool releaseClaims
   * The releaseClaims parameter indicates that you want to release all match claims associated with
    * this reference. This parameter only works when the claim's status is being updated to 'inactive'
    * - you can then set the parameter's value to true to release all match claims produced by this
    * reference.
   * @opt_param string onBehalfOfContentOwner
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of. This parameter supports users whose accounts are associated with multiple content
...
class Google_Service_YouTubePartner_VideoAdvertisingOptions_Resource extends Google_Service_Resource
{
   ...
   * The videoId parameter specifies the YouTube video ID of the video for which you are retrieving
   ...
   *
   * @param string $videoId
   * The videoId parameter specifies the YouTube video ID of the video for which you are updating
    * advertising settings.
...
class Google_Service_YouTubePartner_ClaimMatchInfo extends Google_Model
{
